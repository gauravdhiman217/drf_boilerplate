...
```
cd existing_repo
git remote add origin https://scm.idsil.in/imgauravdhiman/boilerplate.git
git branch -M main
...
- [ ] [Set up project integrations](https://scm.idsil.in/imgauravdhiman/boilerplate/-/settings/integrations)
